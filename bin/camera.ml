...
let output_metadata {image_width;image_height} _ = Printf.printf "P3\n%d %d\n255\n" image_width image_height
...
let get_ray {pixel00_loc; pixel_delta_u; pixel_delta_v; centre} i j = 
    ...
    let pixel_centre = pixel00_loc +.. ((float_of_int i +. offset.x) *.. pixel_delta_u) +.. ((float_of_int j +. offset.y) *.. pixel_delta_v) in
